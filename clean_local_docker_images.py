...
if __name__ == "__main__":
    ...
    containers_running = requests.get(containers_restful_api, timeout=5) #requests.get('http://localhost:2375/containers/json?all=1')    
    containers_running_json = json.loads(containers_running.text)
    images_used_ids = [ i["ImageID"] for i in containers_running_json]
    ...
    #       
    print flag*flag_number, "\n Images Used: ", len(containers_running_json)
